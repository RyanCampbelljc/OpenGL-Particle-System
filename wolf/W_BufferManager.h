...
public:
	...
	// PUBLIC INTERFACE
	//-------------------------------------------------------------------------
	static VertexBuffer* CreateVertexBuffer(unsigned int length, GLenum usage = GL_STATIC_DRAW);
	static VertexBuffer* CreateVertexBuffer(const void* pData, unsigned int length, GLenum usage = GL_STATIC_DRAW);
