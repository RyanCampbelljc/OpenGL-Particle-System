	...
	: m_color(0.4f, 0.4f, 0.4f, 1.0)
{
	...
	m_pMatGrid->SetProgram("assets/shaders/grid.vsh", "assets/shaders/grid.fsh");
	m_pMatGrid->SetDepthTest(true);

	m_pMatAxes = wolf::MaterialManager::CreateMaterial("__gridAxes");
	m_pMatAxes->SetProgram("assets/shaders/grid.vsh", "assets/shaders/grid.fsh");
...
{
	m_pAxesVB =
		wolf::BufferManager::CreateVertexBuffer(axesVertices, sizeof(Vertex) * 2 /* verts per line */ * 3 /* axes */);
